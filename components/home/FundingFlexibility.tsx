        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
          {cards.map((card, i) => (
            <Reveal key={i} delay={Math.min(i * 0.08, 0.4)}>
              <div className="border border-slate-200 dark:border-slate-800 rounded-2xl p-5 sm:p-8 flex items-center gap-5 sm:gap-8 hover:border-brand-500/40 transition-colors h-full">
