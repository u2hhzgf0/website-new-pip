  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-3 sm:gap-4">
        <div>
          <h2 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white">Withdrawal History</h2>
          <p className="text-slate-500 dark:text-slate-400 text-xs sm:text-sm">View your payout records and status</p>
        </div>
