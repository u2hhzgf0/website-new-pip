      ...
      <div className="bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-xl p-4 sm:p-6">
        ...
        {stats.balanceTrend && stats.balanceTrend.length > 0 ? (
          ...
          <div className="h-[300px] flex items-center justify-center">
            <p className="text-slate-600 dark:text-slate-500 text-sm">No balance trend data available</p>
          </div>
        )}
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {stats.incomeBreakdown.map((item, index) => (
            <div key={index} className="space-y-2">
              <div className="flex items-center justify-between mb-2">
                <span className="text-slate-600 dark:text-slate-300 text-sm">{item.category}</span>
              ...
              <p className="text-xs text-slate-600 dark:text-slate-500 mt-1">{item.percentage}% of total income</p>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="bg-white dark:bg-slate-900/50 rounded-lg px-4 py-2">
                <p className="text-xs text-slate-500 dark:text-slate-400">Referral Earnings</p>
